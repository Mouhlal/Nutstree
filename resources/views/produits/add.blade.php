        ...
        <form action="{{ route('prod.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                ...
                <div class="form-group">
                    ...
                    <input type="file" value="{{old('image')}}" name="image" class="w-full p-2 border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
            </div>
