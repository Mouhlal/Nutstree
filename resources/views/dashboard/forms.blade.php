...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex items-center justify-center bg-gray-100">
            <main class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">Contactez Nous</h1>
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="name" name="name" type="text" placeholder="Votre nom" required>
                    </div>
                    <!-- Email -->
                    <div>
                    ...
                    <div>
                        ...
                        <textarea
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            id="message" name="message" rows="5" placeholder="Votre message" required></textarea>
                    </div>
                    <!-- Bouton -->
                    <div>
                        <button
                            class="w-full py-3 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-500 transition duration-200"
