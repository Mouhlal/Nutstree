<nav id="header" class="bg-gray-800 text-white shadow-lg">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
        ...
        <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
            <nav>
                <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                    ...
                    @endguest
                    @guest
                    <li><a class="inline-block text-yellow-400 no-underline hover:text-gray-400 hover:underline py-2 px-4" href="{{route('auth.showRegister')}}">Register</a></li>
                    @endguest
                    @auth
        ...
        <div class="order-2 md:order-3 flex items-center" id="nav-content">
            ...
            <a class="inline-block no-underline hover:text-black"   href="{{ auth()->check() ? route('auth.profile', auth()->user()->id) : route('auth.showLogin') }}">
            ...
            <a class="pl-3 inline-block no-underline text-yellow-400 hover:text-gray-400" href="{{route('cart.show')}}">
